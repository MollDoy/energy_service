...
#### 3.2.3 Проверка параметров запросов
```python
...
#### 3.2.4 API для ручного обновления данных
```python
...
#### 3.2.5 API для получения таблицы данных
```python
@app.route('/api/table')
def api_table():
